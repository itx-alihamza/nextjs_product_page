    ...
    <div className=" flex flex-col bg-[#3B3844] min-w-screen min-h-screen ">
      ...
      <section className="flex flex-col justify-center items-center bg-[url(/images/sec_5_bg.png)] text-center bg-white max-w-screen min-h-[114px] px-10 pb-14">
        ...
        <div className="w-full">
          ...
          <div className="relative min-h-[250px] flex flex-col gap-2 justify-end items-center mt-30 px-6 md:px-15 lg:px-20 xl:px-40 py-8 text-white rounded-2xl bg-[url(/images/sec_5_inbg.png)] bg-cover bg-center">
            <Picture
