    ...
    <div className=" flex flex-col bg-[#3B3844] min-w-screen min-h-screen ">
      ...
      <section className="flex flex-col justify-center items-center bg-[url(/assets/sec_5_bg.png)] text-center bg-white max-w-screen min-h-[114px] px-10 pb-14">
        ...
        <div className="w-full">
          ...
          <div className="w-full">
            <p className="font-light text-center responsive-body">Every day, more riders are choosing NOVA – the Smart Helmet for its unbeatable blend of safety, technology, and style.</p>
        ...
        <div className="w-full flex flex-col justify-around items-center lg:items-start lg:flex-row gap-10 px-8 py-10">
          ...
          <div className="flex flex-col gap-4 items-center ">
            ...
            <ul className="flex flex-col gap-2 list-disc font-light">
              <li className="underline cursor-pointer responsive-body">Home</li>
              <li className="underline cursor-pointer responsive-body">About Us</li>
              <li className="underline cursor-pointer responsive-body">Out Project</li>
              <li className="underline cursor-pointer responsive-body">Pricing</li>
              <li className="underline cursor-pointer responsive-body">Contact</li>
            </ul>
          </div>
          <div className="flex flex-col gap-4 items-center ">
            <h1 className="font-extrabold responsive-heading">Important Links</h1>
            <ul className="flex flex-col gap-2 list-disc font-light">
              <li className="underline cursor-pointer responsive-body">Terms And Conditions</li>
              <li className="underline cursor-pointer responsive-body">Legal</li>
              <li className="underline cursor-pointer responsive-body">Business</li>
              <li className="underline cursor-pointer responsive-body">Partners</li>
            </ul>
          </div>
        </div>
